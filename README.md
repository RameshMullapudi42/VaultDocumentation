...
* The application consists of an app that is installed on client’s device typically an android, iPhone or a windows based device.
* Server side logic that is used to authenticate users, track their roles and accesses and storing meta data of the users.
